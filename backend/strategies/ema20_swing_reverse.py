...
class Strategy(BaseEma20SwingStrategy):
    """EMA20 bearish swing wrapper."""

    state_model = model.EmaSwingReverseState
    state_version_suffix = EMA20_STATE_VERSION_SUFFIX
    strategy_display_name = "EMA20 swing reverse"
    trend_key = "ema20_falling"
    price_position_key = "closed_below_ema20"
    ...
    def _ema_trend_matches(
        ...
        """Return whether EMA20 is falling."""
