...
const DEFAULT_AI_TRUST_OLLAMA_BASE_URL = 'http://localhost:11434'
const DEFAULT_AI_TRUST_TIMEOUT_MS = 10000
const DEFAULT_AI_TRUST_MAX_RETRIES = 0
...
const DEFAULT_AUTOPILOT_BASE_ORDER_STRETCH_MAX_MULTIPLIER = 1
...
export const CONFIG_SUBMIT_PAYLOAD_DEFAULTS: ConfigSubmitPayloadDefaults = {
    ...
    defaultAiTrustOllamaBaseUrl: DEFAULT_AI_TRUST_OLLAMA_BASE_URL,
    defaultAiTrustTimeoutMs: DEFAULT_AI_TRUST_TIMEOUT_MS,
    defaultAiTrustMaxRetries: DEFAULT_AI_TRUST_MAX_RETRIES,
    ...
    defaultAutopilotBaseOrderStretchMaxMultiplier:
        DEFAULT_AUTOPILOT_BASE_ORDER_STRETCH_MAX_MULTIPLIER,
}
