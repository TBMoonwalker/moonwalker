...
const TASKS: readonly ControlCenterTaskPresentation[] = [
    ...
    },
    {
        target: 'dca',
        title: 'Trade modes',
        summary: 'Tune Dynamic DCA runtime behavior.',
        defaultMode: 'setup',
        modes: ['setup', 'advanced'],
...
const KEY_TARGETS: Record<string, ControlCenterTarget> = {
    ...
    signal: 'signal',
    symbol_list: 'signal',
    delisting_protection_enabled: 'signal',
    delisting_schedule_use_trading_credentials: 'signal',
    delisting_schedule_api_key: 'signal',
    delisting_schedule_api_secret: 'signal',
    rsi_max: 'filter',
    ...
    dynamic_so_sizing_mode: 'dca',
    dynamic_so_atr_timeframe: 'dca',
    dynamic_so_atr_length: 'dca',
    dynamic_so_spacing_atr_multiplier: 'dca',
    dynamic_so_recovery_atr_multiplier: 'dca',
    dynamic_so_recovery_min_pct: 'dca',
    dynamic_so_recovery_max_pct: 'dca',
    dynamic_so_max_deal_quote: 'dca',
    dynamic_so_min_tp_improvement_pct: 'dca',
    dynamic_so_execution_guard_enabled: 'dca',
    dynamic_so_execution_drift_atr_fraction: 'dca',
    dynamic_so_execution_drift_min_pct: 'dca',
    dynamic_so_execution_drift_max_pct: 'dca',
